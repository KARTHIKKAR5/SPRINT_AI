...
# Create the complete FastAPI backend for SPRINT.AI with MediaPipe analysis
import os
import zipfile

# Create backend directory structure
os.makedirs("sprint_ai_backend", exist_ok=True)

# Create main.py with complete FastAPI backend
backend_code = '''import math
import os
import tempfile
...
with open("sprint_ai_backend/main.py", "w") as f:
    f.write(backend_code)

print("✅ Backend main.py created")
